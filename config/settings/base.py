...
DISCORD_AT_RISK_BOT_WEBHOOK_BA = env("DISCORD_AT_RISK_BOT_WEBHOOK_BA", default="")
...
DEBANK_API_KEY = env("DEBANK_API_KEY", default="")

BLOCKANALITICA_CORTEX_URL = env("BLOCKANALITICA_CORTEX_URL", default="")
