...
# Generated by Django 4.1.7 on 2023-10-25 09:39
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "ink",
                    models.DecimalField(decimal_places=0, default=0, max_digits=48),
                ),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["ilk", "urn"], name="maker_urnev_ilk_dc3b94_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="urneventstate",
            index=models.Index(
                fields=["block_number"], name="maker_urnev_block_n_435d42_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="urneventstate",
        ...
        migrations.AddIndex(
            model_name="urneventstate",
            index=models.Index(
                fields=["order_index"], name="maker_urnev_order_i_7802fc_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="urneventstate",
            index=models.Index(
                fields=["urn", "ilk", "order_index"], name="maker_urnev_urn_4d4dd8_idx"
            ),
        ),
